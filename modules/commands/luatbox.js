...
"https://4.bp.blogspot.com/-yAExPAr7JeA/WDaBRVuJwxI/AAAAAAALb7I/Dbvda0KD5uECF3_SBjsvkl2_mqP9_BweQCLcB/s1600/AS000834_17.gif",
  ...
  var callback = () => api.sendMessage({body:`Luật Box NO1
👀 Chủ Box: QuangSoSad (Shin)
👤 LUẬT BOX NHƯ SAU:
+Vô box set name theo ae NO1 name
+Có e xinh tươi nào phải gửi info cho admindz
+War=kick
+Không gửi 18+ hay những thứ liên quan
+Out box phải có lý Do✔
+Không sài lệnh bậy bạ của bot
+Nơi này rất văn minh vì vậy cần chất lượng chứ deo cần số lượng.
  👫 Gu Admin :Đíc căng mộng zú to ko xệ =))
  📱 Facebook:https://www.facebook.com/xui.quang
